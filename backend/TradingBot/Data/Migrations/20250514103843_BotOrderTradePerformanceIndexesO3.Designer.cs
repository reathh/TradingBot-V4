...
namespace TradingBot.Data.Migrations
{
    ...
    [Migration("20250514103843_BotOrderTradePerformanceIndexesO3")]
    partial class BotOrderTradePerformanceIndexesO3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TradingBot.Data.Bot", b =>
                {
                    ...
                    b.HasIndex("Enabled", "IsLong");

                    b.HasIndex("IsLong", "MaxPrice", "MinPrice");
            ...
            modelBuilder.Entity("TradingBot.Data.Order", b =>
                {
                    ...
                    b.HasIndex("Status", "QuantityFilled");
